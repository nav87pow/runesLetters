...
const info = [
  {
    ...
    magiclPowerFIrst: "wealth",
    magiclPowerSecond: "comfort",
  ...
  },
  {
    ...
    magiclPowerFIrst: "strength",
    magiclPowerSecond: " healing",
  ...
  },
  {
    ...
    magiclPowerFIrst: "wisdom",
    magiclPowerSecond: " communication",
  ...
  },
  {
    ...
    magiclPowerFIrst: "open locked doors ",
    magiclPowerSecond: " stops enemies",
  ...
  },
  {
    ...
    magiclPowerFIrst: "protection in travel ",
    magiclPowerSecond: ``,
  ...
  },
  {
    ...
    magiclPowerFIrst: "for relationships",
    magiclPowerSecond: ``,
  ...
  },
  {
    ...
    letter: "ᚹ",
    meaning: "joy, light",
    magiclPowerFIrst: "joy",
    magiclPowerSecond: "happiness",
  ...
  },
  {
    ...
    magiclPowerFIrst: "solar magic",
    magiclPowerSecond: "drows on the power of the sun",
  ...
  },
  {
    ...
    magiclPowerFIrst: "love",
    magiclPowerSecond: "lust",
  ...
  },
  {
    ...
    magiclPowerFIrst: "reverses spells",
    magiclPowerSecond: "",
    astrologicalSymbol: "sagittarius",
    imgSrc: sagittarius,
    interpretiveMeaning:
  ...
  },
  {
    ...
    magiclPowerFIrst: "charms animal spirits",
    magiclPowerSecond: "",
  ...
  },
  {
    ...
    magiclPowerFIrst: "brings desires through a natural cycle",
    magiclPowerSecond: "",
    astrologicalSymbol: "pisces",
    imgSrc: pisces,
    interpretiveMeaning:
  ...
  },
  {
    ...
    magiclPowerFIrst: "reveal secrets",
    magiclPowerSecond: "keeps secrets",
  ...
  },
  {
    ...
    magiclPowerFIrst: "transforms troubles",
    magiclPowerSecond: "lightens the heart",
  ...
  },
  {
    ...
    magiclPowerFIrst: "changes the tides",
    magiclPowerSecond: "reverses the current situation",
    astrologicalSymbol: "aquarius",
    imgSrc: aquarius,
    interpretiveMeaning:
  ...
  },
  {
    ...
    magiclPowerFIrst: "breakthroughs",
    magiclPowerSecond: "insight",
    astrologicalSymbol: "taurus",
    imgSrc: taurus,
    interpretiveMeaning:
  ...
  },
  {
    ...
    letter: "ᛚ",
    meaning: "water, sea",
    magiclPowerFIrst: "commands the seas",
    magiclPowerSecond: "",
    astrologicalSymbol: "cancer",
    imgSrc: cancer,
    interpretiveMeaning:
  ...
  },
  {
    ...
    letter: "ᛏ",
    meaning: "harvest, year",
    magiclPowerFIrst: "bring courage to the heart",
    magiclPowerSecond: "",
    astrologicalSymbol: "scorpio",
    imgSrc: scorpio,
    interpretiveMeaning:
  ...
  },
  {
    ...
    magiclPowerFIrst: "creates movment in your current circumstances",
    magiclPowerSecond: "",
    astrologicalSymbol: "virgo",
    imgSrc: virgo,
    interpretiveMeaning:
  ...
  },
  {
    ...
    magiclPowerFIrst: "new beginnings",
    magiclPowerSecond: "",
    astrologicalSymbol: "libra",
    imgSrc: libra,
    interpretiveMeaning:
  ...
  },
  {
    ...
    magiclPowerFIrst: "peace of mind",
    magiclPowerSecond: "",
    astrologicalSymbol: "aries",
    imgSrc: aries,
    interpretiveMeaning:
    ...
    <div className="App">
      <main>
        <nav>
          ...
          <button onClick={handelRandomClick}> ↭ </button>
        ...
        <div className="tagPower">
          <h4>{info[currentRune].magiclPowerFIrst}</h4>
          <h4>{info[currentRune].magiclPowerSecond}</h4>
        </div>
